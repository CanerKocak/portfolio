import {
  ...
  base,
  keyName
} from "./chunk-YW5J6IHC.js";
import "./chunk-2B2CG5KL.js";

// node_modules/.pnpm/@codemirror+state@0.20.1/node_modules/@codemirror/state/dist/index.js
...
// node_modules/.pnpm/@codemirror+view@0.20.7/node_modules/@codemirror/view/dist/index.js
...
var HeightMapBranch = class extends HeightMap {
  ...
  lineAt(value, type, doc2, top, offset) {
    ...
    let base2 = left ? this.left.lineAt(value, type, doc2, top, offset) : this.right.lineAt(value, type, doc2, rightTop, rightOffset);
    ...
    if (left)
      ...
      return this.left.lineAt(rightOffset, subQuery, doc2, top, offset).join(base2);
  }
  forEachLine(from, to, doc2, top, offset, f) {
    let rightTop = top + this.left.height, rightOffset = offset + this.left.length + this.break;
    if (this.break) {
...
function measureRange(view, range) {
  ...
  function piece(left, top, right, bottom) {
    return new Piece(left - base2.left, top - base2.top - 0.01, right - left, bottom - top + 0.01, "cm-selectionBackground");
  }
...
// node_modules/.pnpm/@lezer+common@0.16.1/node_modules/@lezer/common/dist/index.js
...
// node_modules/.pnpm/@lezer+highlight@0.16.0/node_modules/@lezer/highlight/dist/index.js
var nextTagID = 0;
var Tag = class _Tag {
  /// @internal
...
// node_modules/.pnpm/@codemirror+language@0.20.2/node_modules/@codemirror/language/dist/index.js
var _a;
...
function foldGutter(config2 = {}) {
  ...
  let markers = ViewPlugin.fromClass(class {
    ...
    update(update) {
      if (update.docChanged || update.viewportChanged || update.startState.facet(language) != update.state.facet(language) || update.startState.field(foldState, false) != update.state.field(foldState, false) || syntaxTree(update.startState) != syntaxTree(update.state))
...
// node_modules/.pnpm/@codemirror+commands@0.20.0/node_modules/@codemirror/commands/dist/index.js
...
// node_modules/.pnpm/@codemirror+search@0.20.1/node_modules/@codemirror/search/dist/index.js
...
var RegExpQuery = class extends QueryType2 {
  ...
  highlight(doc2, from, to, add2) {
    let cursor = regexpCursor(this.spec, doc2, Math.max(
      0,
      from - 250
      /* HighlightMargin */
    ), Math.min(to + 250, doc2.length));
    while (!cursor.next().done)
      add2(cursor.value.from, cursor.value.to);
  }
};
...
// node_modules/.pnpm/@codemirror+autocomplete@0.20.3/node_modules/@codemirror/autocomplete/dist/index.js
...
var CompletionDialog = class _CompletionDialog {
  ...
  setSelected(selected, id) {
    return selected == this.selected || selected >= this.options.length ? this : new _CompletionDialog(this.options, makeAttrs(id, selected), this.tooltip, this.timestamp, selected);
  }
  ...
  map(changes) {
    return new _CompletionDialog(this.options, this.attrs, Object.assign(Object.assign({}, this.tooltip), { pos: changes.mapPos(this.tooltip.pos) }), this.timestamp, this.selected);
  }
};
...
// node_modules/.pnpm/@codemirror+lint@0.20.3/node_modules/@codemirror/lint/dist/index.js
...
//# sourceMappingURL=@codemirror_basic-setup.js.map
