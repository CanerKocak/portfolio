...
declare module '$env/static/private' {
	...
	export const DFX_MOC_PATH: string;
	export const TERM_PROGRAM_VERSION: string;
	export const npm_package_devDependencies_vite_plugin_environment: string;
	...
	export const npm_package_dependencies__codemirror_lang_rust: string;
	...
	export const npm_package_dependencies__codemirror_basic_setup: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_devDependencies_vite_plugin_environment: string;
		...
		USER: string;
		NVM_DIR: string;
		npm_package_dependencies__codemirror_lang_rust: string;
		...
		COLORTERM: string;
		npm_package_dependencies__codemirror_basic_setup: string;
